...
/**
 * Provides the local service interface for Employ. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see EmployLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface EmployLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.entryservice.service.impl.EmployLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the employ local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link EmployLocalServiceUtil} if injection and service tracking are not available.
	 */
