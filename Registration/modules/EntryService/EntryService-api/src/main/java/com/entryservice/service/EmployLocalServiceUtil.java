...
/**
 * Provides the local service utility for Employ. This utility wraps
 * <code>com.entryservice.service.impl.EmployLocalServiceImpl</code> and
 ...
 * @generated
 */
public class EmployLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.entryservice.service.impl.EmployLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Employ addEmploy(Employ employ) {
		return getService().addEmploy(employ);
	}
	 ...
	 */
	public static Employ createEmploy(long sid) {
		return getService().createEmploy(sid);
	}
	 ...
	 */
	public static Employ deleteEmploy(Employ employ) {
		return getService().deleteEmploy(employ);
	}
	 ...
	 */
	public static Employ deleteEmploy(long sid) throws PortalException {
		return getService().deleteEmploy(sid);
	}
	...
	public static Employ fetchEmploy(long sid) {
		return getService().fetchEmploy(sid);
	}
	 ...
	 * @throws PortalException if a employ with the primary key could not be found
	 */
	public static Employ getEmploy(long sid) throws PortalException {
		return getService().getEmploy(sid);
	}
	 ...
	 */
	public static List<Employ> getEmploys(int start, int end) {
		return getService().getEmploys(start, end);
	}
	 ...
	 */
	public static int getEmploysCount() {
		return getService().getEmploysCount();
	}
	 ...
	 */
	public static Employ updateEmploy(Employ employ) {
		return getService().updateEmploy(employ);
	}

	public static EmployLocalService getService() {
		return _service;
	}

	private static volatile EmployLocalService _service;
