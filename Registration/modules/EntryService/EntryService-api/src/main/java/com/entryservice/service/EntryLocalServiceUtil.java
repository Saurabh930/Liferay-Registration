 ...
 * <code>com.entryservice.service.impl.EntryLocalServiceImpl</code> and
...
public class EntryLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.entryservice.service.impl.EntryLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Entry createEntry(long sid) {
		return getService().createEntry(sid);
	}
	 ...
	 */
	public static Entry deleteEntry(long sid) throws PortalException {
		return getService().deleteEntry(sid);
	}
	...
	public static Entry fetchEntry(long sid) {
		return getService().fetchEntry(sid);
	}
	 ...
	 * @throws PortalException if a entry with the primary key could not be found
	 */
	public static Entry getEntry(long sid) throws PortalException {
		return getService().getEntry(sid);
	}
