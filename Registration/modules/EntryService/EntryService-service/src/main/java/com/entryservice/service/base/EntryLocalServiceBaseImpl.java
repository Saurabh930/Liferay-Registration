...
import com.entryservice.service.EntryLocalService;
import com.entryservice.service.EntryLocalServiceUtil;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.entryservice.service.impl.EntryLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.entryservice.service.impl.EntryLocalServiceImpl
 * @generated
 */
public abstract class EntryLocalServiceBaseImpl
	...
	public Entry createEntry(long sid) {
		return entryPersistence.create(sid);
	}
	...
	public Entry deleteEntry(long sid) throws PortalException {
		return entryPersistence.remove(sid);
	}
	...
	public Entry fetchEntry(long sid) {
		return entryPersistence.fetchByPrimaryKey(sid);
	}
	...
	public Entry getEntry(long sid) throws PortalException {
		return entryPersistence.findByPrimaryKey(sid);
	}
